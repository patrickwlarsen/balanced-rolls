...
const addonName = 'Gargul_BalancedRolls';
const sourcePath = path.join(scriptDir, addonName);
const destPath = path.join(addonInstallPath, addonName);
...
log('Deploying', addonName, 'to', destPath);
